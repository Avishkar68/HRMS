    ...
    <aside className="w-64 min-h-screen bg-white border-r border-gray-200 flex flex-col justify-between flex-shrink-0">
      ...
      <div className="flex flex-col">
        ...
        <nav className="flex flex-col gap-2 p-4 pt-6">
          ...
          <NavLink to="/employee/attendance/mark" className={navLinkStyle}>
          ...
          <NavLink to="/employee/apply-leave" className={navLinkStyle}>
            <CalendarPlus className="w-4 h-4" />
            Apply Leave
          </NavLink>
          <NavLink to="/employee/tasks" className={navLinkStyle}>
            <CheckSquare className="w-4 h-4" />
            My Tasks
          </NavLink>
          <NavLink to="/employee/timesheets" className={navLinkStyle}>
            <CalendarRange className="w-4 h-4" />
            My Timesheets
          </NavLink>
          <NavLink to="/employee/appraisals" className={navLinkStyle}>
            <Award className="w-4 h-4" />
            My Reviews
          </NavLink>
          <NavLink to="/employee/service-book" className={navLinkStyle}>
            <BookOpen className="w-4 h-4" />
            My Service Book
          </NavLink>
          <NavLink to="/employee/payslips" className={navLinkStyle}>
