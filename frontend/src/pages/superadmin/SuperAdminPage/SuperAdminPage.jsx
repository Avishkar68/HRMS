    ...
    <div className="flex flex-col md:flex-row min-h-screen bg-gray-50">
      ...
      <header className="md:hidden bg-white border-b border-gray-200 p-4 flex items-center justify-between sticky top-0 z-30 shadow-xs">
        <div className="flex items-center gap-3">
          ...
          <span className="font-black text-gray-900 text-sm tracking-tight">SUPERADMIN</span>
        </div>
        <div className="text-[10px] bg-indigo-950 text-indigo-200 font-bold px-2.5 py-1 rounded-full border border-indigo-900">
          Global
        </div>
      </header>
