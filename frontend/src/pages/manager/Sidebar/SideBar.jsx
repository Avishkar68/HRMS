    ...
    <aside className="w-64 min-h-screen bg-white border-r border-gray-200 flex flex-col justify-between">
      ...
      <div className="flex flex-col">
        ...
        <div className="p-6 border-b border-gray-100 flex items-center gap-2 bg-gradient-to-br from-slate-50 to-white">
          ...
          <div>
            <h2 className="font-black text-gray-950 text-sm tracking-tight leading-none">PORTAL MANAGER</h2>
        ...
        <nav className="flex flex-col gap-2 p-4 pt-6">
          <NavLink to="/manager/dashboard" className={navLinkStyle}>
            <LayoutDashboard className="w-4 h-4" />
            Dashboard
          </NavLink>
          <NavLink to="/manager/team-attendance" className={navLinkStyle}>
