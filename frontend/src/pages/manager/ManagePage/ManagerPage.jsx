      ...
      <header className="md:hidden bg-white border-b border-gray-200 p-4 flex items-center justify-between sticky top-0 z-30 shadow-xs">
        <div className="flex items-center gap-3">
          <button
            ...
            className="p-2 hover:bg-gray-100 rounded-xl text-gray-650 transition-all active:scale-[0.95]"
            aria-label="Toggle Sidebar"
          >
            <Menu className="w-5 h-5" />
          </button>
          <span className="font-black text-gray-900 text-sm tracking-tight">PORTAL MANAGER</span>
        </div>
